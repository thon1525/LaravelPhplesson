            ...
            <ul class="sidebar-menu">
                ...
                {{-- end aside controller --}}
                    ...
                    <li class='treeview'>
                        <a href='#'><i class='fa fa-fire'></i> <span>{{ trans('crudbooster.API_Generator') }}</span>  <i class="fa fa-angle-{{ trans("crudbooster.right") }} pull-{{ trans("crudbooster.right") }}"></i></a>
                        <ul class='treeview-menu'>
                            <li class="{{ (Request::is(config('crudbooster.ADMIN_PATH').'/api_generator/generator*')) ? 'active' : '' }}"><a href='{{Route("ApiCustomControllerGetIndex")}}?m=0'><i class='fa fa-plus'></i> {{ trans('crudbooster.Add_New_API') }}</a></li>
                           {{--  <li class="{{ (Request::is(config('crudbooster.ADMIN_PATH').'/api_generator')) ? 'active' : '' }}"><a ><i class='fa fa-bars'></i> {{ trans('crudbooster.list_API') }}</a></li>
                            <li class="{{ (Request::is(config('crudbooster.ADMIN_PATH').'/api_generator/screet-key*')) ? 'active' : '' }}"><a href='{{Route("ApiCustomControllerGetScreetKey")}}?m=0'><i class='fa fa-bars'></i> {{ trans('crudbooster.Generate_Screet_Key') }}</a></li> --}}
                        </ul>
                    </li>
